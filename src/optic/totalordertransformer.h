...
namespace Planner
{
    ...
    public:
        ...
        /**
         *  Returns the index of the most recent step in the plan - the step which, due to the total order
         * constraints, must precede the ends of all actions that have started but not yet finished.
         *
