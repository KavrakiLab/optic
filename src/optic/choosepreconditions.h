...
namespace Planner
{
    ...
    namespace NNFPreconditionChooser
    {
        ...
        struct Supporters
        {
            ...
            Supporters(const int &p, const bool &t) : pref(p), meetsTheTrigger(t), satisfyIt(true)
            {
            }
        };

        extern pair<bool, double> satisfyNNFEarly(MinimalState &s, const vector<double> &minTimestamps,
