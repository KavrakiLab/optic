...
MILPSolverBoth::MILPSolverBoth() : solvers(debugBoth ? 4 : 2)
{
...
MILPSolverBoth::MILPSolverBoth(const MILPSolverBoth &c) : solvers(debugBoth ? 4 : 2)
{
...
void MILPSolverBoth::addCol(const vector<pair<int, double>> &entries, const double &lb, const double &ub,
