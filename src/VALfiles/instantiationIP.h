...
struct LiteralParameterIterator
{
    ...
    LiteralParameterIterator(FastEnvironment *f, parameter_symbol_list::const_iterator p) : env(f), pi(p){};
...
public:
    ...
    void write(ostream &o) const
    {
        ...
        transform(prop->args->begin(), prop->args->end(), ostream_iterator<string>(o, "_"),
...
public:
    ...
    {
        o << "  " << op->name->getName() << "_";
        transform(op->parameters->begin(), op->parameters->end(), ostream_iterator<string>(o, "_"),
