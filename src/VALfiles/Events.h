...
namespace VAL
{
    ...
    private:
        ...
        vector<const Action *> eventsForMutexCheck;  // these are actions that are triggered the same time as
                                                     // an action, stored here for extra mutex checks
    ...
    const vector<const_symbol_list *> getParametersDiscrete(goal *g, operator_ *op, const State &s,
                                                            bool neg = false);
    const vector<const_symbol_list *> getParametersCts(goal *g, operator_ *op, Validator *v, bool neg = false,
                                                       bool atAPoint = false);
    const vector<const_symbol_list *> getParameters(goal *g, operator_ *op, Validator *v, bool discrete,
                                                    bool neg = false, bool atAPoint = false);
    const vector<const_symbol_list *> getParametersList(goal *g, operator_ *op, Validator *v,
                                                        ...
                                                        bool discrete, bool atAPoint = false);
    ...
    const vector<const_symbol_list *> defineUndefinedParametersPropVar(
        const vector<const_symbol_list *> &vcsl, operator_ *op, Validator *vld, goal *g, bool dp, bool neg,
        const set<var_symbol *> &svs, bool compError = false);
