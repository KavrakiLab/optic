...
namespace VAL
{
    ...
    public:
        ...
        {
            derivedPreconds.push_back(o);
        };

        void addAdd(operator_ *o)
        {
            adds.push_back(o);
        };

        void addAdd(derivation_rule *o)
        {
            derivedAdds.push_back(o);
        };

        void addDel(operator_ *o)
        {
            dels.push_back(o);
        };
        ...
        void write(ostream &o) const
        {
            ...
            for (vector<operator_ *>::const_iterator i = preconds.begin(); i != preconds.end(); ++i)
            {
                if (*i)
                {
                    o << "\t" << (*i)->name->getName() << "\n";
            ...
            {
                o << "Adds:\n";
                for (vector<operator_ *>::const_iterator i = adds.begin(); i != adds.end(); ++i)
                {
                    if (*i)
                    {
                        o << "\t" << (*i)->name->getName() << "\n";
            ...
            o << "Dels:\n";
            for (vector<operator_ *>::const_iterator i = dels.begin(); i != dels.end(); ++i)
            {
                if (*i)
                {
                    o << "\t" << (*i)->name->getName() << "\n";
