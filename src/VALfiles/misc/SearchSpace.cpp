...
namespace Planner
{
    ...
    SearchSpace::SearchSpace()
      ...
      , val(&derivRules, 0.001, *VAL::theTC, VAL::current_analysis->the_domain->ops,
            VAL::current_analysis->the_problem->initial_state, &dummyPlan,
            VAL::current_analysis->the_problem->metric, true, true, 0, 0)
