...
namespace Inst
{
    ...
    public:
        ...
        SpikeIterator toLevel(int i)
        {
            return spk.begin() + levelheads[i];
        };
    };
    ...
    public:
        ...
        bool represents(const Literal *lit) const
        {
            return theprop == lit;
        };

        void setInitiallyFalse()
        {
            initiallyTrue = false;
        };
    ...
    public:
        ...
        bool represents(const instantiatedOp *op) const
        {
            return op == theact;
        };
    ...
    public:
        DurationConstraint(BoundedValue *b) : Constraint(b), start(0), inv(0), end(0){};

        void setStart(ActEntry *s)
        {
            start = s;
        };

        void setEnd(ActEntry *e)
        {
            end = e;
        };

        void setInv(ActEntry *i)
        {
            inv = i;
        };
    ...
    public:
        ...
        virtual bool gotLB() const
        {
            return true;
        };

        virtual bool gotUB() const
        {
            return true;
        };
    ...
    public:
        BoundedInterval(double l, double u) : finitelbnd(true), lbnd(l), finiteubnd(true), ubnd(u){};
    ...
    public:
        ...
        BoundedValue *getBV() const
        {
            return bval;
        };

        bool represents(const PNE *pne) const
        {
            return pne == thefluent;
        };
    ...
    {
    public:
        virtual PropEntry *makePropEntry(Literal *l)
        {
            return new PropEntry(l);
        };
    ...
    public:
        ...
        BoundedValue *update(BoundedValue *bv, const VAL::expression *exp, const VAL::assign_op op,
