...
namespace VAL
{
    ...
    struct UnsatPrecondition : public UnsatCondition
    {
        ...
        UnsatPrecondition(double t, const Action *a, const State *s)
          : UnsatCondition(*s, a->getPrecondition()->getAdviceProp(s)), time(t), action(a){};
        ~UnsatPrecondition(){};
        void display() const;
        void advice() const;
    ...
    struct UnsatGoal : public UnsatCondition
    {
        ...
        UnsatGoal(const Proposition *p, const State *s) : UnsatCondition(*s, p->getAdviceProp(s)), pre(p){};
    ...
    struct UnsatConditionFactory
    {
        ...
        virtual UnsatPrecondition *buildUnsatPrecondition(double t, const Action *a, const State *s)
        {
            return new UnsatPrecondition(t, a, s);
        };

        virtual UnsatDurationCondition *buildUnsatDurationCondition(double t, const Action *a, const State *s,
                                                                    double e)
        {
            return new UnsatDurationCondition(t, a, s, e);
        };

        virtual MutexViolation *buildMutexViolation(double t, const Action *a1, const Action *a2,
                                                    const State *s)
        {
        ...
        virtual UnsatInvariant *buildUnsatInvariant(double st, double e, const Intervals &ints,
                                                    const Action *a, const State *s, bool re)
        {
    ...
    public:
        ...
        void addUnsatInvariant(double st, double e, Intervals ints, const Action *a, const State *s,
