...
namespace VAL
{
    ...
    public:
        ...
        proposition(pred_symbol *h, var_symbol_list *a) : head(h), args(new parameter_symbol_list)
        {
    ...
    {
    public:
        plus_expression(expression *a1, expression *a2) : binary_expression(a1, a2){};
    ...
    {
    public:
        minus_expression(expression *a1, expression *a2) : binary_expression(a1, a2){};
    ...
    {
    public:
        mul_expression(expression *a1, expression *a2) : binary_expression(a1, a2){};
    ...
    {
    public:
        div_expression(expression *a1, expression *a2) : binary_expression(a1, a2){};
    ...
    public:
        func_term(func_symbol *fs, parameter_symbol_list *psl) : func_sym(fs), param_list(psl){};
    ...
    public:
        assignment(func_term *ft, assign_op a_op, expression *e) : f_term(ft), op(a_op), expr(e){};
    ...
    {
    public:
        action(operator_symbol *nm, var_symbol_list *ps, goal *pre, effect_lists *effs, var_symbol_table *st)
    ...
    {
    public:
        event(operator_symbol *nm, var_symbol_list *ps, goal *pre, effect_lists *effs, var_symbol_table *st)
          : operator_(nm, ps, pre, effs, st){};
        virtual ~event(){};
        virtual void display(int ind) const;
        virtual void write(ostream &o) const;
    ...
    {
    public:
        process(operator_symbol *nm, var_symbol_list *ps, goal *pre, effect_lists *effs, var_symbol_table *st)
          : operator_(nm, ps, pre, effs, st){};
        virtual ~process(){};
        virtual void display(int ind) const;
        virtual void write(ostream &o) const;
    ...
    public:
        ...
        plan_step(operator_symbol *o, const_symbol_list *p) : op_sym(o), params(p){};
    ...
    public:
        ...
        virtual action *buildAction(operator_symbol *nm, var_symbol_list *ps, goal *pre, effect_lists *effs,
                                    var_symbol_table *st)
        {
        ...
        virtual event *buildEvent(operator_symbol *nm, var_symbol_list *ps, goal *pre, effect_lists *effs,
                                  var_symbol_table *st)
        {
            return new event(nm, ps, pre, effs, st);
        };

        virtual process *buildProcess(operator_symbol *nm, var_symbol_list *ps, goal *pre, effect_lists *effs,
                                      var_symbol_table *st)
        {
    ...
    public:
        ...
        action *buildAction(operator_symbol *nm, var_symbol_list *ps, goal *pre, effect_lists *effs,
                            var_symbol_table *st)
        {
            return strucFactory->buildAction(nm, ps, pre, effs, st);
        };

        event *buildEvent(operator_symbol *nm, var_symbol_list *ps, goal *pre, effect_lists *effs,
                          var_symbol_table *st)
        {
            return strucFactory->buildEvent(nm, ps, pre, effs, st);
        };

        process *buildProcess(operator_symbol *nm, var_symbol_list *ps, goal *pre, effect_lists *effs,
                              var_symbol_table *st)
        {
