...
namespace VAL
{
    ...
    struct WriteController
    {
        ...
        virtual void write_goal_list(ostream &o, const goal_list *p)
        {
            p->pc_list<goal *>::write(o);
        };
        ...
        virtual void write_pred_decl_list(ostream &o, const pred_decl_list *p)
        {
            p->pc_list<pred_decl *>::write(o);
        };

        virtual void write_func_decl_list(ostream &o, const func_decl_list *p)
        {
            p->pc_list<func_decl *>::write(o);
        };
        ...
        virtual void write_operator_list(ostream &o, const operator_list *p)
        {
            p->pc_list<operator_ *>::write(o);
        };

        virtual void write_derivations_list(ostream &o, const derivations_list *d)
        {
            d->pc_list<derivation_rule *>::write(o);
        };
