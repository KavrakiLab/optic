...
namespace VAL
{
    ...
    void
        requires(pddl_req_flag flags)
    {
        if (!(flags & current_analysis->req))
        {
            current_analysis->error_list.add(E_WARNING,
                                             "Undeclared requirement " + pddl_req_flags_string(flags));
        }
    }
    ...
    string pddl_req_flags_string(pddl_req_flag flags)
    {
        ...
        if (flags & E_NFLUENTS)
        {
            result += ":number-fluents ";
        }
        if (flags & E_OFLUENTS)
        {
            result += ":object-fluents ";
        }
        if (flags & E_ACTIONCOSTS)
        {
            result += ":action-costs ";
        }
    ...
    void symbol::visit(VisitController *v) const
    {
        v->visit_symbol(this);
    };
    ...
    void func_term::visit(VisitController *v) const
    {
        v->visit_func_term(this);
    };
    ...
    void conj_goal::visit(VisitController *v) const
    {
        v->visit_conj_goal(this);
    };

    void disj_goal::visit(VisitController *v) const
    {
        v->visit_disj_goal(this);
    };
    ...
    void neg_goal::visit(VisitController *v) const
    {
        v->visit_neg_goal(this);
    };
    ...
    void pred_decl::visit(VisitController *v) const
    {
        v->visit_pred_decl(this);
    };

    void func_decl::visit(VisitController *v) const
    {
    ...
    void operator_::visit(VisitController *v) const
    {
        v->visit_operator_(this);
    };

    void action::visit(VisitController *v) const
    {
        v->visit_action(this);
    };

    void event::visit(VisitController *v) const
    {
        v->visit_event(this);
    };

    void process::visit(VisitController *v) const
    {
        v->visit_process(this);
    };
    ...
    void domain::visit(VisitController *v) const
    {
        v->visit_domain(this);
    };
    ...
    void problem::visit(VisitController *v) const
    {
        v->visit_problem(this);
    };

    void plan_step::visit(VisitController *v) const
    {
        v->visit_plan_step(this);
    };
