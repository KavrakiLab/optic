...
namespace VAL
{
    ...
    public:
        ...
        const LogicalState &getLogicalState() const
        {
            return logState;
        };
        ...
        set<const FuncExp *> getChangedPNEs() const
        {
            return changedPNEs;
        };
        ...
        public:
            ...
            {
                while (it != st.logState.end() && !it->second)
                {
                    ++it;
                }
            };
        ...
        static void addObserver(StateObserver *s)
        {
            sos.push_back(s);
        }
